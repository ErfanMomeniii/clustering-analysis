...
from clustering_analysis.distance import get_metric, AVAILABLE_METRICS

VEC = st.lists(st.floats(min_value=-10, max_value=10, allow_nan=False, allow_infinity=False),
